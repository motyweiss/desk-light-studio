...
>(({ className, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-white/10 backdrop-blur-sm border border-white/10 shadow-[inset_0_1px_3px_rgba(0,0,0,0.3)]">
      <SliderPrimitive.Range className="absolute h-full bg-gradient-to-r from-[hsl(38_65%_50%)] to-[hsl(42_60%_55%)] shadow-[0_0_10px_rgba(200,160,80,0.35)] transition-shadow duration-300" />
