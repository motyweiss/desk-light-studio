      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: PLAYER_TRANSITIONS.popover.duration }}
          ...
          {/* Popover */}
          <motion.div
            initial={{ opacity: 0, scale: 0.96, y: PLAYER_TRANSITIONS.popover.y }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.96, y: PLAYER_TRANSITIONS.popover.y }}
            transition={{ 
              duration: PLAYER_TRANSITIONS.popover.duration, 
              ease: PLAYER_TRANSITIONS.popover.ease
            }}
            style={{
              position: 'fixed',
