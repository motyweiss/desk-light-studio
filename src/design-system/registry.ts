...
export const componentRegistry: ComponentInfo[] = [
  ...
  {
    name: 'TrendGraph',
    path: '@/features/climate/components/TrendGraph',
    description: 'Minimalist trend graph showing 24-hour sensor data with smooth path animations',
    category: 'features',
    props: [
      { name: 'data', type: 'number[]', required: true, description: 'Array of data points' },
      { name: 'width', type: 'number', default: '120' },
      { name: 'height', type: 'number', default: '40' },
      { name: 'color', type: 'string', default: 'hsl(var(--status-comfortable))' },
      { name: 'animate', type: 'boolean', default: 'true' },
    ],
    usedIn: ['ClimateIndicatorTooltip'],
    hasStorybook: false,
  },
  {
    name: 'ClimateIndicatorTooltip',
    path: '@/features/climate/components/ClimateIndicatorTooltip',
    description: 'Interactive tooltip for climate sensors with trend graph and detailed information',
    category: 'features',
    props: [
      ...
      { name: 'unit', type: 'string', required: true },
      { name: 'trendData', type: 'number[]', required: true },
      { name: 'color', type: 'string', required: true },
      { name: 'position', type: "'top' | 'bottom'", default: 'bottom' },
      { name: 'onToggle', type: 'function', required: true },
      { name: 'progressValue', type: 'number', required: true },
      { name: 'progressMax', type: 'number', required: true },
      { name: 'progressMin', type: 'number', default: '0' },
      { name: 'colorType', type: "'temperature' | 'humidity' | 'airQuality'", required: true },
    ],
    usedIn: ['ClimateIndicators'],
    hasStorybook: false,
  },
  {
