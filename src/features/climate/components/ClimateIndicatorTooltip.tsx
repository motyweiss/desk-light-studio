      ...
      {createPortal(
        <AnimatePresence mode="wait">
          {isOpen && trendData.length > 0 && (
            ...
            >
              <div className="bg-black/60 backdrop-blur-2xl backdrop-saturate-150 rounded-2xl px-4 py-3.5 shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/8 min-w-[200px]">
